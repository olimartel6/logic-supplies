...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900" style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
      ...
      <section ref={heroRef} className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 md:py-28 relative">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden md:block">
              <div className="bg-slate-800/60 rounded-2xl border border-slate-700/50 p-6 shadow-2xl backdrop-blur">
                <div className="flex items-center gap-2 mb-4">
                  <span className="w-3 h-3 rounded-full bg-red-400" />
                  <span className="w-3 h-3 rounded-full bg-yellow-400" />
                  <span className="w-3 h-3 rounded-full bg-green-400" />
                  <span className="text-xs text-slate-500 ml-2">logicsupplies.ca</span>
                </div>
                {/* Step-by-step animated demo */}
                <div className="space-y-3">
                  {/* Step 1: Employee request */}
                  <div className="animate-[fadeSlideIn_0.6s_ease_0.3s_both]">
                    <div className="bg-slate-700/50 rounded-xl p-3 border border-slate-600/30">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-[10px] text-white font-bold">1</span>
                        <span className="text-xs text-slate-400">Employé fait une demande</span>
                      </div>
                      <div className="bg-slate-800/80 rounded-lg p-2.5 text-sm">
                        <span className="text-white font-medium">Fil 14/2 NMD90 150m</span>
                        <span className="text-slate-500 ml-2">x1</span>
                      </div>
                    </div>
                  </div>
                  {/* Step 2: Price comparison */}
                  <div className="animate-[fadeSlideIn_0.6s_ease_0.9s_both]">
                    <div className="bg-slate-700/50 rounded-xl p-3 border border-slate-600/30">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="w-6 h-6 bg-cyan-500 rounded-full flex items-center justify-center text-[10px] text-white font-bold">2</span>
                        <span className="text-xs text-slate-400">Comparaison de prix automatique</span>
                      </div>
                      <div className="space-y-1.5">
                        <div className="flex items-center justify-between bg-green-500/10 border border-green-500/20 rounded-lg px-3 py-1.5">
                          <span className="text-green-400 text-sm font-medium">Lumen</span>
                          <span className="text-green-300 text-sm font-bold">89.99$</span>
                        </div>
                        <div className="flex items-center justify-between bg-slate-800/50 rounded-lg px-3 py-1.5">
                          <span className="text-slate-400 text-sm">Canac</span>
                          <span className="text-slate-300 text-sm">94.50$</span>
                        </div>
                        <div className="flex items-center justify-between bg-slate-800/50 rounded-lg px-3 py-1.5">
                          <span className="text-slate-400 text-sm">Home Depot</span>
                          <span className="text-slate-300 text-sm">102.00$</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  {/* Step 3: Approve + auto-order */}
                  <div className="animate-[fadeSlideIn_0.6s_ease_1.5s_both]">
                    <div className="bg-slate-700/50 rounded-xl p-3 border border-slate-600/30">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-[10px] text-white font-bold">3</span>
                        <span className="text-xs text-slate-400">Approuver → commande automatique</span>
                      </div>
                      <div className="flex gap-2">
                        <div className="flex-1 bg-green-500/20 border border-green-500/30 rounded-lg py-2 text-center text-green-400 text-sm font-semibold animate-pulse">
                          Approuver — 89.99$
                        </div>
                      </div>
                    </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <FadeIn delay={0}>
              ...
              <p className="text-gray-500 mt-2 font-medium">Fournisseurs connectés</p>
            </FadeIn>
            <FadeIn delay={0.15}>
              <div className="text-4xl md:text-5xl font-extrabold text-blue-600">
                <Counter end={30} suffix="s" />
              </div>
              <p className="text-gray-500 mt-2 font-medium">Pour passer une commande</p>
            </FadeIn>
            <FadeIn delay={0.3}>
              <div className="text-4xl md:text-5xl font-extrabold text-blue-600">
                <Counter end={100} suffix="%" />
              </div>
              <p className="text-gray-500 mt-2 font-medium">Automatisé</p>
            </FadeIn>
            <FadeIn delay={0.45}>
              <div className="text-4xl md:text-5xl font-extrabold text-blue-600">
                <Counter end={0} suffix="$" />
              </div>
              <p className="text-gray-500 mt-2 font-medium">Pour commencer</p>
            </FadeIn>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Pour chaque produit demandé, LogicSupplies compare les prix chez vos 11 fournisseurs connectés et sélectionne la meilleure offre. Économisez sans effort.',
              },
              {
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
              ...
              <FadeIn key={i} delay={(i % 3) * 0.15}>
                <div className="bg-white rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition group h-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <FadeIn key={i} delay={(i % 4) * 0.1}>
                <div className="bg-gray-50 rounded-xl p-6 hover:bg-blue-50 transition border border-gray-100 h-full">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {suppliers.map((s, i) => (
              <FadeIn key={s} delay={i * 0.05}>
                <div className="bg-white border border-gray-200 rounded-xl px-6 py-3 font-semibold text-gray-700 hover:border-blue-300 hover:text-blue-600 transition shadow-sm">
                  {s}
                </div>
              </FadeIn>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-slate-500">
              &copy; 2026 LogicSupplies. Tous droits réservés.
            </p>
          </div>
        </div>
      </footer>
      ...
      <div
        ...
        style={{
          ...
          transform: showFloatingCta ? 'translateY(0) scale(1)' : 'translateY(20px) scale(0.9)',
          pointerEvents: showFloatingCta ? 'auto' : 'none',
        }}
      >
        <a
          href={`${APP_URL}/?mode=signup`}
          className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3.5 rounded-full shadow-xl shadow-blue-500/30 transition hover:scale-105"
        >
