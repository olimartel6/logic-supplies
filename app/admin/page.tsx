  ...
  return (
    <div className="pb-20 md:pb-6 md:ml-56">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 md:max-w-none md:mx-0">
        ...
        {/* Tabs */}
        <div className="flex gap-2 mb-6 bg-gray-100 p-1 rounded-xl md:hidden">
          <button
        ...
        {/* Users tab */}
        <div className={`${tab !== 'users' ? 'hidden' : ''} md:block`}>
          <div className="hidden md:flex items-center gap-2.5 mb-4 pb-3 border-b-2 border-blue-200">
            <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-4.5 h-4.5 text-blue-600">
...
<select value={userForm.role} onChange={e => setUserForm({ ...userForm, role: e.target.value })} className="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        {/* Job sites tab */}
        <div className={`${tab !== 'sites' ? 'hidden' : ''} md:block`}>
          <div className="hidden md:flex items-center gap-2.5 mb-4 pb-3 border-b-2 border-amber-200">
            <div className="w-8 h-8 rounded-lg bg-amber-100 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-4.5 h-4.5 text-amber-600">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
              </svg>
            </div>
            <h2 className="text-lg font-bold text-gray-900">Chantiers</h2>
          </div>
            <div className="flex items-center justify-between mb-3">
